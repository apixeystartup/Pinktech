...
export function AuthProvider({ children }) {
  ...
  const applySessionPayload = useCallback((data) => {
    ...
    if (baseUser) {
      const nextUser = { ...baseUser, tenantId: baseUser.tenantId, tenantCode: tenant?.code || baseUser.tenantCode };
  ...
  const login = async (email, password) => {
    ...
    try {
      ...
      const nextUser =
        baseUser && org ? { ...baseUser, tenantId: baseUser.tenantId || org._id, tenantCode: org.code } : baseUser;
