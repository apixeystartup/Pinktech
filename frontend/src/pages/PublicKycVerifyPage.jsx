    ...
    <section className="auth-container">
      <div className="auth-card">
        ...
        <p className="small-note">
          Use the link from your email (it loads this page). Enter the OTP from the same message, then your document details below.
          details below.
        </p>
        {error ? (
        ...
        {!result?.ok ? (
          <form className="stacked-form" onSubmit={submit}>
            ...
            <button className="btn-primary" type="submit" disabled={loading || !kycId || !token}>
